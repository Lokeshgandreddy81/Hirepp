    ...
    <div className="bg-white">
      ...
      <div className="relative overflow-hidden">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span className="block xl:inline">Hire top talent with</span>{' '}
                  <span className="block text-blue-600 xl:inline">AI-powered matching</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Cut your time-to-hire in half. Use our Smart Interview videos, intelligent ranking systems, and automated feedback loops to build your dream team faster.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 bg-blue-50 flex items-center justify-center">
          ...
          <div className="text-blue-300 text-6xl font-bold p-20 text-center">
            Intelligent<br />Matchmaking.
          </div>
        </div>
      </div>
    </div>
